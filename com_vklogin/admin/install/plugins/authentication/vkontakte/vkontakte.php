		...
		if ($credentials['username'] == 'VK_LOGIN' && $credentials['password'] == 'VK_PASSWORD')
		{
					...
					.trim($vkConfig->get('secret'))) == $session->get('sig', 'error'))
			{
				...
				if ($row = $db->loadObject())
				{
					...
					$photo_rec = (preg_match('#http://cs\d+\.userapi.com\.com/u\d+/e_[a-z0-9]+\.jpg|http://userapi.com\.com/images/question_e\.gif#',
						$toUpdate['photo_rec']))?$toUpdate['photo_rec']:'';
					$photo_big = (preg_match('#http://cs\d+\.userapi.com\.com/u\d+/a_[a-z0-9]+\.jpg|http://userapi.com\.com/images/question_a\.gif#',
						$toUpdate['photo_big']))?$toUpdate['photo_big']:'';
					$photo_medium = (preg_match('#http://cs\d+\.userapi.com\.com/u\d+/b_[a-z0-9]+\.jpg|http://userapi.com\.com/images/question_b\.gif#',
						$toUpdate['photo_medium']))?$toUpdate['photo_medium']:'';
					$photo_medium_rec = (preg_match('#http://cs\d+\.userapi.com\.com/u\d+/d_[a-z0-9]+\.jpg|http://userapi.com\.com/images/question_d\.gif#',
						$toUpdate['photo_medium_rec']))?$toUpdate['photo_medium_rec']:'';
					$photo = (preg_match('#http://cs\d+\.userapi.com\.com/u\d+/e_[a-z0-9]+\.jpg|http://userapi.com\.com/images/question_e\.gif#',
